...
function printTenantReceipt(idx) {
  ...
  <div class="header"><div><div class="brand">RENTFLOW</div></div><div class="receipt-label"><div style="font-size:11px;font-weight:700;color:#9CA3AF;text-transform:uppercase;letter-spacing:1px">Rent Receipt</div><div class="receipt-no">#${receiptNo}</div><div style="font-size:12px;color:#6b7280;margin-top:4px">${date}</div></div></div>
  ...
  <div class="footer"><p>Thank you for your payment.</p><small>Generated by RentFlow · Property Management Software</small></div>
